...
class AppServiceProvider extends ServiceProvider {
    ...
    public function register()
    {
        ...
        View::addLocation($pathCustom);
        View::addNamespace('admin', $pathCustom . '/Admin');
        View::addNamespace('front', $pathCustom . '/Frontend');

        View::addLocation($pathMain);
        View::addNamespace('admin', $pathMain . '/Admin');
        View::addNamespace('front', $pathMain . '/Frontend');
