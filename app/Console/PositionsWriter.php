...
class PositionsWriter
{
    ...
    protected function setCurrentDriver($position): void
    {
        ...
        if ($driver) {
            if ($this->device->current_driver_id == $driver->id && !$this->isHistory($position->time)) {
                return;
            }
        ...
        $this->device->changeDriver(null, $rfid, $position->time);
    }
    ...
    protected function write()
    {
        ...
        if ($this->device->traccar) {
            ...
            if ($engineChanged)
                event(new DeviceEngineChanged($this->device, $engineChanged));
        }
    ...
    protected function writePositions()
    {
        ...
        try {
            ...
            if ($e->getCode() == '42S02') {
                ...
                app(ExceptionHandler::class)->reportBugsnag($e);
            }
        }
    }
