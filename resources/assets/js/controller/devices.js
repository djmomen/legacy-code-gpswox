function Devices() {
    ...
    _this.activeMulti = function(group_id, value) {
        ...
        if (!value) {
            _this.changeVisibleGroup(group_id, false);
        }
        _this.changeActive(payload, value);
    };
    ...
    _this.displayVisibleGroup = function(group_id) {
        $.each( items, function(id, device) {
            if ( ! device )
                return;
    ...
    _this.changeActive = function( data, status ) {
        ...
        $.ajax({
            ...
            success: function(){
                if ((!status) && (!data.s)) {
                    _this.changeVisibleGroup(data.group_id, status)
                    return;
                }

                _this.load(app.urls.devicesMap, data, function() {
                    _this.displayVisibleGroup(data.group_id);
                });
            },
        });
    };
