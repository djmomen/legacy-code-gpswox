function EventSys(data) {
    ...
    _this.popup = function() {
        ...
        if (app.settings.canCreateCallAction) {
            nav += '<li data-toggle="tooltip" data-placement="top" title="Call action"><a href="javascript:" data-url="' + app.urls.callActionCreate + options.device_id + '?event_id=' + options.id + '" data-modal="call_action_create"><i class="fa fa-phone fa-1"></i></a></li>';
        }
