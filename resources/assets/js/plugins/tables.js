...
var tables = {
    ...
    getFilters: function(table) {
        ...
        return $filters.filter(function(index) {
            ...
            .reduce((accumulator, element) => {
                if (accumulator.hasOwnProperty(element.name)) {
                    if (!Array.isArray(accumulator[element.name])) {
                        accumulator[element.name] = [accumulator[element.name]];
                    }
                    accumulator[element.name].push(element.value);
                } else {
