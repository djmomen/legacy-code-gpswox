...
class GroupContainer
{
     ...
     * @return Group[]
     */
    public function activesOpen(): array
    {
        return array_filter($this->actives(), fn(Group $group) => $group->isOpen());
    }

    /**
     * @return Group[]
     */
    public function activesClosed(): array
    {
        return array_filter($this->actives(), fn(Group $group) => $group->isClose());
    }
