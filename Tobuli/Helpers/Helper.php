...
function getJsConfig()
{
    ...
    return [
            ...
            'firstLogin' => $user && $user->isFirstLogin(),
            ...
            'settings' => [
                ...
                'homeViewEnabled' => $user->perm('home_view', 'view'),
                'canCreateCallAction' => $user->perm('call_actions', 'edit') && $user->perm('events', 'view'),
            ...
            'urls' => [
                ...
                'callActionCreate' => route('call_actions.create', 0),
