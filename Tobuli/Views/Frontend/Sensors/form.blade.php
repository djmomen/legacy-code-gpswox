<div class="row">
    <div class="col-md-12 sen-data-fields">
        ...
        <div class="row">
            <div class="col-sm-4" data-sensor-input="add_to_history">
                <div class="form-group">
                    <div class="checkbox">
            ...
            <div class="col-sm-4" data-sensor-input="add_to_graph">
                <div class="form-group">
                    <div class="checkbox">
            ...
            <div class="col-sm-4" data-sensor-input="add_to_widgets">
                <div class="form-group">
                    <div class="checkbox">
                        {!! Form::checkbox('add_to_widgets', 1, $item->add_to_widgets ?? true) !!}
                        {!! Form::label('add_to_widgets', trans('front.add_to_widgets')) !!}
                    </div>
                </div>
            </div>
        </div>
