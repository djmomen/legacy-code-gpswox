                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" role="menu" aria-labelledby="dropTools">
                            ...
                            @endif
                            @if ( Auth::User()->perm('home_view', 'edit') )
                            <li id="home_view_link">
                                <a href="javascript:" data-url="{{ route('home_view.create') }}" data-modal="home_view" role="button">
                                    <span class="icon point"></span>
                                    <span class="text">{!!trans('front.home_view')!!}</span>
                                </a>
                            </li>
                            @endif
