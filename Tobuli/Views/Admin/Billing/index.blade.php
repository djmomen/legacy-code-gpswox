                ...
                <div class="panel-body">
                    ...
                    <div data-disablable="#enable_plans;show-enable">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <div class="input-group">
                                    <div class="checkbox input-group-btn">
                                        {!! Form::hidden('enable_devices_limit', 0) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <div class="input-group">
                                    <div class="checkbox input-group-btn">
                                        {!! Form::hidden('enable_subscription_expiration_after_days', 0) !!}
                    ...
                    <div data-disablable="#enable_plans;hide-disable">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <div class="checkbox">
                                    {!! Form::hidden('allow_user_change_plan', 0) !!}
